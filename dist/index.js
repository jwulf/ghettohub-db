...
const droptable_1 = __webpack_require__(130);
const dropdb_1 = __webpack_require__(561);
const Operations = {
    INIT: init_1.init,
...
class DatabaseDriver {
    ...
    dropDB() {
        if (fs_1.default.existsSync(this.basedir)) {
            fs_1.default.rmdirSync(this.basedir, { recursive: true });
            this.dirty = true;
        }
    }
    dropTable(tablename) {
